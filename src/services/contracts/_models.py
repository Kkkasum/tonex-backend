...
class ClaimContractOp(BaseModel):
    deposit: int = 0x95db9d39
    claim: int = 0xa769de27
    first_claim: int = 0x862ad82d
    withdraw_ton: int = 0x37726bdb
    withdraw_jetton: int = 0x11c09682
    withdraw_emergency: int = 0x781282d4
    boost: int = 0x56642768


class UserContractOp(BaseModel):
    deposit: int = 0x95db9d39
    claim: int = 0xa769de27
    boost: int = 0x56642768
